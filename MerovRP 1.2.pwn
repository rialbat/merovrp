...
{
    SPD(playerid, 23, DIALOG_STYLE_INPUT, !"Ŕäěčí-ŕâňîđčçŕöč˙", !"\
...
cmd:makeleader(playerid, params[])
{
	...
	SavePlayer(params[0], "Rank", player[params[0]][prank], "d");
	static const
		fmt_str[] = "Âű íŕçíŕ÷čëč %s[%d] íŕ ëčäĺđęó",
	    fmt_str_2[] = "Ŕäěčíčńňđŕňîđ %s[%d] íŕçíŕ÷čë %s[%d] íŕ ëčäĺđęó";
	new
 		string[sizeof(fmt_str) + MAX_PLAYER_NAME],
